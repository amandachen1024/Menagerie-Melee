...
public class AutoBattler extends JFrame implements ActionListener
{
    ...
    public AutoBattler()
    {
        ...
        startPanel = new ImagePanel(new ImageIcon(getClass().getResource("AutoBattlerImages/startBackground.png")).getImage().getScaledInstance(getWidth(), getHeight(), Image.SCALE_DEFAULT));
        startPanel.setLayout(new GridBagLayout());
        recruitPanel = new ImagePanel(new ImageIcon(getClass().getResource("AutoBattlerImages/recruitBackground.png")).getImage().getScaledInstance(getWidth(), getHeight(), Image.SCALE_DEFAULT));
        recruitPanel.setLayout(new GridBagLayout());
        recapPanel = new ImagePanel(new ImageIcon(getClass().getResource("AutoBattlerImages/recapBackground.png")).getImage().getScaledInstance(getWidth(), getHeight(), Image.SCALE_DEFAULT));
        recapPanel.setLayout(new GridBagLayout());
        fightPanel = new ImagePanel(new ImageIcon(getClass().getResource("AutoBattlerImages/battleBackground.png")).getImage().getScaledInstance(getWidth(), getHeight(), Image.SCALE_DEFAULT));
        fightPanel.setLayout(new GridBagLayout());
        endPanel = new ImagePanel(new ImageIcon(getClass().getResource("AutoBattlerImages/endBackground.png")).getImage().getScaledInstance(getWidth(), getHeight(), Image.SCALE_DEFAULT));
        endPanel.setLayout(new GridBagLayout());
        constraints = new GridBagConstraints();

        introHeader = new JLabel("Welcome to Menagerie Melee!");
    ...
    public static void recruit(Warband w) throws IOException {
        ...
        recruitLabel.setHorizontalAlignment(GridBagConstraints.CENTER);
